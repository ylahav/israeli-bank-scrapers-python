"""Port of src/scrapers/one-zero-queries.ts — GraphQL query strings, copied verbatim.

These are just static strings sent to the GraphQL API; nothing to translate.
"""
